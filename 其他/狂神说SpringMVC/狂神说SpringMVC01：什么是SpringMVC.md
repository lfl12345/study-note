...
秦疆 [狂神说](javascript:void(0);) *2020-03-30*
...
dispatcherServlet使用handlerMapping把URL映射到bean的id，然后在使用handleradapter把bean的id映射到controller接着controller返回handleradapter数据。然后数据和目的地又转到了dispatcherServlet，dispatcher调用viewresolver
